...
set -x AOCDIR $HOME/repos/aoc

# Perl
. ~/perl5/perlbrew/etc/perlbrew.fish
set -x PERL_MB_OPT "--install_base \"/home/eax/perl5\""
set -x PERL_MM_OPT "INSTALL_BASE=/home/eax/perl5"
# }}}
# Starship prompt {{{
...
# scripting
alias gorun="entr bash -c \"go run $argv\" \< \<(find .)"
alias perlrun="entr bash -c \"perl $argv\" \< \<(find .)"
alias pyrun="entr bash -c \"python $argv\" \< \<(find .)"
